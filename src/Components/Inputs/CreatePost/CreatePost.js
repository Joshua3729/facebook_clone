...
const CreatePost = (props) => {
  ...
  const postPhoto_preview = useSelector(
    (state) => state.home.previewPost_photo
  );
  ...
  return (
    <div className={classes.CreatePost}>
      ...
      >
        ...
        <div className={classes.post_area_wrapper}>
          <textarea
            ...
            value={post_caption}
            onChange={(e) =>
              dispatch(HomeActions.setPostCaption(e.target.value))
            }
          ></textarea>

          <div className={classes.post_image_wrapper}>
            <img src={postPhoto_preview} />
          </div>
        </div>
        ...
        <div className={classes.addToYourPost}>
          ...
          <div className={classes.options_wrapper}>
            <div className={classes.media_wrapper}>
              ...
              <label for="file-picker" className={classes.filePicker_label}>
                <svg
                  fill="currentColor"
                  viewBox="0 0 24 24"
